...
export default function SignUpScreen() {
    ...
    return (
        <LinearGradient 
        colors={['#ffeb3b', '#ff9800']} // Customize the gradient colors as you like
        ...
        >
            ...
            <View className="h-full w-full flex justify-around pt-48">
                ...
                <View className="flex items-center">
                    <Animated.Text entering={FadeInUp.duration(1000).springify()} className="text-white font-bold tracking-wider text-4xl mt-5">
                        SignUp
                    </Animated.Text>
                </View>
