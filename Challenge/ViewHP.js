  ...
  const fetchProfileData = async () => {
    try {
      ...
      const challengesJoined = challengesData.filter(challenge => 
        challenge.participantsID && challenge.participantsID.includes(userId)
      ).length;
      ...
      const ranking = sortedUsers.findIndex(([userid]) => userid === userId) + 1;
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerTitleContainer}>
              <Text style={styles.headerTitle}>{userData?.fullname || 'Runner'}'s</Text>
              <Text style={styles.headerSubtitle}>Health Profile</Text>
            </View>
          </View>
        </Animatable.View>
        ...
        >
          ...
          >
            {/* Profile Section with Avatar and Level Logo side by side */}
